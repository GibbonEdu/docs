...
In addition, if [your school has configured it](/get-started/configuration/integrations/google-integration), it is also possible to login using a Google account.
