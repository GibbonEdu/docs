...
*   In order to generate your PO file, use a variant of this [xgettextGenerationCommands.sh shell script](https://github.com/GibbonEdu/i18n/blob/main/xgettextGenerationCommands.sh)
