...
- [minimum]({{< ref "api/Gibbon/Forms/Input/Number/index.md#minimum" >}})
- [maximum]({{< ref "api/Gibbon/Forms/Input/Number/index.md#maximum" >}})
- [decimalPlaces]({{< ref "api/Gibbon/Forms/Input/Number/index.md#decimalplaces" >}})
- [onlyInteger]({{< ref "api/Gibbon/Forms/Input/Number/index.md#onlyinteger" >}})
