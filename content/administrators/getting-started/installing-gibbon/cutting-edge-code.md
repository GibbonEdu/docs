...
After updating a Cutting Edge code installation, you may see a message that composer needs updated. To do this, navigate to your root Gibbon folder and run the `composer install` command once to install or update the libraries in your vendor folder.
