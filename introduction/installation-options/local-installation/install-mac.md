...
3. Double-click `MAMP & MAP PRO Downloader.app` to download the appropriate version of MAMP for your Mac.
4. Double-click `MAMP-MAMP-PRO-7.4-Intel-x86.pkg` to start the installation. By default, MAMP is installed at `/Applications/MAMP`.
...
1. Create a new folder called `gibbon` in the MAMP web root directory. This can be done on your desktop or by running the following command in Terminal:
...
In the Miscelleneous section, select country, currency and timezone.
...
* Log into Gibbon using the admin account created during installation.
...
* [Backing up your system](https://docs.gibbonedu.org/administration/backing-up-your-system) provides instructions on backing up data in to Gibbon.
